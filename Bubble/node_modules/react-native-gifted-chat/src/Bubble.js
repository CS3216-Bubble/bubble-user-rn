...
var adjectives = require('../../../app/utils/adjectives');
var animals = require('../../../app/utils/animals');
...
export default class Bubble extends React.Component {
  ...
  handleBubbleToNext() {
    if (this.props.isSameUser(this.props.currentMessage, this.props.nextMessage) && this.props.isSameDay(this.props.currentMessage, this.props.nextMessage) && this.props.nextMessage.type != "REACTION") {
  ...
  handleBubbleToPrevious() {
    if (this.props.isSameUser(this.props.currentMessage, this.props.previousMessage) && this.props.isSameDay(this.props.currentMessage, this.props.previousMessage) && this.props.previousMessage.type != "REACTION") {
  ...
  renderTime() {
    if (this.props.currentMessage.createdAt && this.props.currentMessage.type != "REACTION") {
  ...
  renderReactionView(senderID, receiverID, variant) {
    var senderName = this.generateName(senderID);
    var receiverName = this.generateName(receiverID);
  ...
  render() {
    // Render Reactions
    if (this.props.currentMessage.type == "REACTION" && this.props.currentMessage.target != null) {
      return (
            ...
            <View style={[styles[this.props.position].wrapper, this.props.wrapperStyle[this.props.position], this.handleBubbleToNext(), this.handleBubbleToPrevious()]}>
              <TouchableWithoutFeedback onLongPress={this.onLongPress} accessibilityTraits="text" {...this.props.touchableProps} >
                <View>
                  ...
                  {this.renderMessageImage()}
                  {this.renderMessageText()}
                 {this.props.currentMessage.type != "REACTION" && <View style={styles.bottom}>
                    {this.renderTime()}
                    {this.renderTicks()}
                  </View>}
                </View>
      ...
      return (
        ...
        { Platform.OS == 'ios' ?
              this.renderName()
            : <View style={[styles[this.props.position].container, this.props.containerStyle[this.props.position]]}>{this.renderName()}</View>
        }
          <View style={[styles[this.props.position].container, this.props.containerStyle[this.props.position]]}>
            <View style={[styles[this.props.position].wrapper, this.props.wrapperStyle[this.props.position], this.handleBubbleToNext(), this.handleBubbleToPrevious()]}>
              <TouchableWithoutFeedback onLongPress={this.onLongPress} accessibilityTraits="text" {...this.props.touchableProps} >
