...
export default class Bubble extends React.Component {
  ...
  handleBubbleToPrevious() {
    if (this.props.isSameUser(this.props.currentMessage, this.props.previousMessage) && this.props.isSameDay(this.props.currentMessage, this.props.previousMessage) && this.props.previousMessage.type != "REACTION"  && this.props.nextMessage.type != "JOIN_ROOM" && this.props.nextMessage.type != "EXIT_ROOM") {
  ...
  renderTime() {
    if (this.props.currentMessage.createdAt && this.props.currentMessage.type != "REACTION"  && this.props.nextMessage.type != "JOIN_ROOM" && this.props.nextMessage.type != "EXIT_ROOM") {
            ...
            <View style={[styles[this.props.position].wrapper, this.props.wrapperStyle[this.props.position], this.handleBubbleToNext(), this.handleBubbleToPrevious()]}>
              <TouchableWithoutFeedback onLongPress={this.onLongPress} accessibilityTraits="text" {...this.props.touchableProps} >
                <View>
                  ...
                  {this.renderMessageImage()}
                  {this.renderMessageText()}
                 {this.props.currentMessage.type != "REACTION"  && this.props.nextMessage.type != "JOIN_ROOM" && this.props.nextMessage.type != "EXIT_ROOM" && <View style={styles.bottom}>
                    {this.renderTime()}
                    {this.renderTicks()}
                  </View>}
                </View>
