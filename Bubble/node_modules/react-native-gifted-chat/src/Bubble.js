...
export default class Bubble extends React.Component {
  ...
  renderReactionView(senderID, receiverID, variant) {
    ...
    if (senderID == this.props.currBubbleId) {
      senderName = 'You';
    }

    if (receiverID == this.props.currBubbleId) {
    ...
    switch (variant) {
      case "THANK":
        return (<View style={{ height: 40, marginTop: 0, marginBottom: 0, alignSelf: 'stretch' }}>
      ...
      case "CHEER":
        return (
          <View style={{ height: 40, marginTop: 0, marginBottom: 0, alignSelf: 'stretch', }}>
            <View style={{flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center'}}>
              <Image
              source={{uri: senderAvatar}}  style={{height: 20, width: 20, borderRadius: 10, marginLeft: 5, marginRight: 5}}/>
              <Text style={{ textAlign: 'center', fontSize: 10, fontWeight: '500', color: 'grey', }} >
