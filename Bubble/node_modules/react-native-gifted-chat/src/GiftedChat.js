...
class GiftedChat extends React.Component {
  ...
  renderChatFooter() {
    ...
    // }
    // return null;
    return  ((this.props.someoneTyping !== '') ? 
    <View style={{flexDirection: 'row', alignItems: "center", justifyContent: "flex-start"}}> 
      <Text style={{padding: 5, fontSize: 10, fontWeight: "500"}}> 
        {this.props.someoneTyping} is typing
      </Text>  
      <Bubbles size={2} color="#C9C9C9" /> 
    </View>
    : null);
  }
...
GiftedChat.propTypes = {
  ...
  someoneTyping: React.PropTypes.string,
  onTyping: React.PropTypes.func,
  onTypingStop: React.PropTypes.func,
